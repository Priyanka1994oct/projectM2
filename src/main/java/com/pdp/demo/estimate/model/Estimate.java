package com.pdp.demo.estimate.model;
...
public class Estimate {
	...
	@Column(name="estimate_dateStr")
	private String estimate_dateStr;
	public void setEstimate_dateStr(String estimate_dateStr) {
		this.estimate_dateStr = estimate_dateStr;
	}
	public String getEstimate_dateStr() {
		return estimate_dateStr;
	}
